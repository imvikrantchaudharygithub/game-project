...
export default function Footer() {
    ...
    return (
      ...
      <a href="https://www.facebook.com/profile.php?id=61564485991235&mibextid=LQQJ4d" className="group transition-all duration-500 hover:-translate-y-2">
      ...
      <a href="https://www.instagram.com/moneymonkey.online?igsh=MXF1bnZveHkxNTh6&utm_source=qr" className="group transition-all duration-500 hover:-translate-y-2">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
      ...
      <a href="https://t.me/monkeymoneygames" className="group transition-all duration-500 hover:-translate-y-2">
      ...
      {/* <a href="#" className="group transition-all duration-500 hover:-translate-y-2">
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
                    ...
                    <div className="footer-bottom padding-tb">
                        ...
                        <div className="footer-content d-grid">
                            <div className="footer-content-left">
                                <p>You can earn more money through the investment. Monkey money is able to satisfy million of user across the country. Monkey money has its priority set on its gaming community , ensuring and everlasting and endlessly entertaining gaming experience.
Your use of and access to monkey money signifies  that you  fully understand and agree to be legally bound by the contents of our terms of service and responsible gaming policy.</p>
                            </div>
